 ...
 *
 * Synchronous Node.js port of the framework's addressing format 3 in
...
// Format 3 addresses every blob by its bytes, so text and its UTF-8 encoding
// intentionally share the same domain and content address.
