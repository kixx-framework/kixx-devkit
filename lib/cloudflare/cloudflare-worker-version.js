 ...
 *
 * Supported binding types: `d1`, `durable_object_namespace`, `inherit`,
 * `kv_namespace`, `plain_text`, `r2_bucket`, `secret_text`, and `version_metadata`. Any other
    ...
    addBinding(binding) {
        ...
        if (type === 'inherit') {
            assert(
                ...
                `CloudflareWorkerVersion#addBinding() inherit binding "${ name }" requires an exact version_id`,
            );
        }
